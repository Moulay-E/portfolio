...
export const projectData = [
  {
    title: 'Argent Bank',
    subtile: 'Gestion des Connexions Utilisateurs et Interface de Compte',
    description:
  ...
  {
    title: '724 Events',
    subtile: 'Optimisation et Débogage du Site Web pour 724events',
    description:
  ...
  {
    title: 'Kasa',
    subtile: "Refonte Innovante du Site de Location d'Appartements avec React",
    description:
  ...
  },
  {
    title: 'Nina Carducci',
    subtile:
      'Optimisation Complète du Portfolio de Nina Carducci, Photographe Professionnelle',
    description:
      "Ce projet ambitieux a consisté à revigorer le portfolio en ligne de Nina Carducci, une photographe renommée. Mon rôle était d'optimiser toutes les images pour un chargement rapide et une qualité visuelle supérieure, tout en mettant en œuvre des stratégies de référencement local pour améliorer sa visibilité en ligne. J'ai également intégré des métadonnées spécifiques pour renforcer la présence du portfolio sur les réseaux sociaux. En outre, j'ai concentré mes efforts sur l'amélioration du SEO et de l'accessibilité du site, en utilisant des outils tels que Lighthouse et Wave pour assurer une conformité optimale aux meilleures pratiques web actuelles. Ce travail a non seulement amélioré la performance technique du site mais a également fourni une plateforme plus engageante et accessible pour mettre en valeur le talent artistique de Nina.",
    cover: ninaIMg,
    link: 'https://moulay-e.github.io/P9_Nina_Carducci/',
    tags: ['SEO', 'Js', 'Wave', 'Lightousse'],
  },
  //   {
  //     title: 'p6',
  ...
  //   },
  {
    title: 'oh my food',
    subtile:
      'Conception Mobile-First pour une Expérience Utilisateur Optimalisée',
    description:
  ...
  {
    title: 'Booki',
    subtile: 'Transformation de Concepts de Design en une Réalité Numérique',
    description:
